...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno) {
        ...
        education.setBounds(300, 314, 400, 30);
        ...
        String occupationallValues[] = {"Salaried", "Self-Employed", "Business", "Doctrate", "Student", "Retired", "Others"};
        occupation = new JComboBox(occupationallValues);
